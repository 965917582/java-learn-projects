...
public class OrderController {
    ...
    public String pay(Integer orderId, BigDecimal totalPrice) throws Exception {
        ...
        map.put("subject","chepiao"+new Date());
    ...
    @ResponseBody
    public String changePayStatus( String out_trade_no, HttpServletRequest req){
    ...
    @ResponseBody
    public ResponseMsg generateOrder(@RequestParam(value = "goodsIdList")String goodsIdList
            , @RequestParam(value = "goodsNumList")String goodsNumList
            , @RequestParam(value = "goodsPriceList")String goodsPriceList
    ...
    @RequestMapping(value = "/deleteOrderByGoodsId",method = RequestMethod.POST)
    @ResponseBody
    public ResponseMsg deleteOrderByGoodsId(Integer orderId,Integer goodsId){
        orderService.deleteOrderByGoodsId(orderId,goodsId);
