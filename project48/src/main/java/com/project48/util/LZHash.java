...
public class LZHash {
    ...
    int replcaNum = 100;//虚拟节点副本数量，需要大一些，能更好地保证均衡性
...
//        return Hashing.md5().newHasher().putString(source, Charsets.UTF_8).hash().toString();
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 100000; i++) {
            ...
            if(node.equals("127.0.0.1:6379")) {
                node220 ++;
            }if(node.equals("127.0.0.1:6380")) {
                node233 ++;
            }if(node.equals("127.0.0.1:6381")) {
                node60 ++;
            }
        }
