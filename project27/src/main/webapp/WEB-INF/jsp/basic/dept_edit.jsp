  ...
  <body>
    ...
    <form action="/emp/deptManage_editDept.do" method="post" onsubmit="return checkFrm();">
      <table width="500" align="center" style="margin-top:30px" class="inputTable">
        <tr>
          <th>部门名称：</th>
          <td><input class="text" name="deptName" value="${deptName}"/>
            <input type="hidden" name="deptId" value="${deptId}" />
          </td>
        </tr>
        <tr>
          <th>联系人：</th>
          <td><input class="text" name="linkman" value="${linkman}"/></td>
        </tr>
        <tr>
          <th>电话：</th>
          <td><input class="text" name="tel" value="${tel}"/></td>
        </tr>
        <tr>
          <th>地址：</th>
          <td><textarea class="text" name="address" style="width:300px;height:46px">${address}</textarea></td>
        </tr>
        <tr>
          <th>备注：</th>
          <td><textarea class="text" name="remark" style="width:300px;height:46px">${remark}</textarea></td>
        </tr>       
      </table>
